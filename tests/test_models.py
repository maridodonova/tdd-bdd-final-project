...
class TestProductModel(unittest.TestCase):
    ...
    def test_read_a_product(self):
        ...
        product = ProductFactory()
        app.logger.info(f"New product for reading: {product}")
        product.id = None
        product.create()
        self.assertIsNotNone(product.id)
        # Read a product
    ...
    def test_update_a_product(self):
        ...
        product = ProductFactory()
        app.logger.info(f"New product for updating: {product}")
        product.id = None
        product.create()
        app.logger.info(f"Created product for updating: {product}")
        self.assertIsNotNone(product.id)
    ...
    def test_find_by_price(self):
        ...
        # Find by price in str format
        str_price = str(price)
        found_products = Product.find_by_price(str_price)
        self.assertEqual(found_products.count(), count)
        for product in found_products:
            self.assertEqual(product.price, price)
